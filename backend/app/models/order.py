...
class Order(Base):
    ...
    tracking_history = relationship("Tracking", back_populates="order", cascade="all, delete-orphan")
    cancellation = relationship("Cancellation", back_populates="order", uselist=False, cascade="all, delete-orphan")
    revenue = relationship("RevenueLeakage", back_populates="order", uselist=False, cascade="all, delete-orphan")
    payments = relationship("Payment", back_populates="order", cascade="all, delete-orphan", order_by="Payment.id")
